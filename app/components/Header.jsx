...
const Header = () => {
  return (
    <div className="w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4">
      ...
      <h1 className="text-3xl sm:text-6ml lg:text-[66px] font-Ovo mb-2">
        Full Stack Web Developer
      </h1>
      <p className="max-w-2xl mx-auto font-Ovo">
        I’m a full-stack web developer driven by a passion for building
        immersive digital experiences that blend intuitive design with powerful
        backend logic.
      </p>
