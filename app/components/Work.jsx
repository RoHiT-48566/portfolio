  ...
  return (
    <div id="work" className="w-full px-[12%] py-10 scroll-mt-20">
      ...
      <a
        ...
        target="_blank"
        className="w-max flex items-center justify-center gap-2 test-gray-700 border-[0.5px] border-gray-700 rounded-full py-3 px-10 mx-auto my-20 hover:bg-lightHover duration-500"
      >
        Show more{" "}
        <Image
